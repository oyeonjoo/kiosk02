...
public class Kiosk {
    ...
    private final ArrayList<Product> burgerMenu = new ArrayList<Product>(); // 버거 메뉴판
    private final ArrayList<Product> frozenMenu = new ArrayList<Product>(); // 프로즌 메뉴판
    private final ArrayList<Product> drinkMenu = new ArrayList<Product>(); // 드링크 메뉴판-가변성이 좋아서 사용
    //private Menu menu;
    private final Order order = new Order();

    public void welcome() {
        String info = "\"SHAKE SHACK BURGER 에 오신걸 환영합니다.\"\n"  +
    ...
    public void printCategory() {
        ...
        String category =  "[ SHACK SHACK MENU ]\n"
